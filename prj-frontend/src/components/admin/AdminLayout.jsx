...
export const AdminLayout = () => {
    ...
    const navItems = [
        ...
        { path: '/admin/announcements', label: t('nav_broadcast'), icon: Megaphone },
    ];
        ...
        <div className="flex min-h-screen font-sans text-[var(--text-primary)] transition-colors duration-500 bg-[var(--bg-primary)]">
            ...
            >
                ...
                <footer className="p-4 border-t border-[var(--border-color)]/50 bg-[var(--bg-secondary)] flex-none overflow-hidden">
                    <Link 
                        to="/admin/settings"
                        className={`flex items-center gap-3 p-3 rounded-2xl bg-[var(--bg-primary)] border border-[var(--border-color)]/50 transition-all group cursor-pointer hover:bg-[var(--text-primary)] hover:border-[var(--text-primary)] ${!isSidebarOpen ? 'justify-center' : ''}`}
                    >
                        ...
                        {isSidebarOpen && (
                            <div className="flex-1 min-w-0 animate-fade-in">
                                ...
                                <p className="text-[9px] text-[var(--text-primary)]/60 uppercase tracking-wider font-black leading-none truncate group-hover:text-[var(--bg-primary)]/60">
                                    {t('auth_verified')}
                                </p>
                            </div>
                        )}
