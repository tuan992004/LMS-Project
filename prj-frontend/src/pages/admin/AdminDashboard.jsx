        ...
        <div className="max-w-7xl mx-auto p-8">
            <header className="mb-10">
                ...
                <p className="text-[var(--text-secondary)] mt-1 font-medium">
                    Welcome back, <span className="text-[var(--text-primary)]">{user?.fullname || 'Admin'}</span>. Here's what's happening today.
                </p>
            </header>
            ...
            <div className="mt-10 grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2 insta-card p-8 min-h-[300px] flex items-center justify-center border-dashed border-2">
                    <p className="text-[var(--text-secondary)] font-bold italic opacity-40 uppercase tracking-tighter text-4xl select-none">Activity Overview</p>
                </div>
                <div className="insta-card p-8 flex items-center justify-center border-dashed border-2">
                    <p className="text-[var(--text-secondary)] font-bold italic opacity-40 uppercase tracking-tighter text-2xl select-none">Quick Actions</p>
                </div>
            </div>
        </div>
    );
